...
<header id="navbar" class="flex justify-between items-center text-white p-4">
    <nav>
        <div class="titulonavbar">
            ...
            <span class="text">Painel do Tutor</span>
        </div>
...
<div id="sidebar" class="sidebar">
  ...
  <a href="agendatutor.php"><i class='bx bx-calendar'></i> <span class="sidebar-text">Agenda</span></a>
  <a href="petstutor.php"><i class='bx bxs-cat'></i> <span class="sidebar-text">Pets</span></a>
  <a href="historico.php"><i class='bx bxs-user'></i> <span class="sidebar-text">Usuario</span></a>
  <a href="historico.php"><i class='bx bxs-bell-ring'></i> <span class="sidebar-text">notificações</span></a>
  <a href="historico.php"><i class='bx bxs-cog'></i> <span class="sidebar-text">Configurações</span></a>
...
<body>
  ...
  <div class="vet-container">
        <div class="vet-options-grid">
            <div class="vet-option-card" onclick="irPara('agendatutor')">
                <div class="vet-icon">
                    <i class='bx bxs-calendar-check'></i>
                </div>
            ...
            <div class="vet-option-card" onclick="irPara('petstutor')">
                <div class="vet-icon">
                    <i class='bx bxs-user-detail'></i>
                </div>
                <h2>Seus Pets</h2>
                <p>Acesse as informações dos seus pets, incluindo histórico médico.</p>
            </div>
            ...
            <div class="vet-option-card" onclick="irPara('usuariotutor')">
                <div class="vet-icon">
            ...
            <div class="vet-option-card" onclick="irPara('notificacaotutor')">
                <div class="vet-icon">
            ...
            <div class="vet-option-card" onclick="irPara('configuracoestutor')">
                <div class="vet-icon">
...
function irPara(pagina) {
    // Aqui você pode especificar o caminho da página que deseja abrir
    window.location.href = pagina + ".php"; // Altere ".php" conforme a extensão da sua página
}
</script>
</body>
