    ...
    public function listar()
{
    ...
    $sql = "SELECT p.idPaciente, p.nome, p.especie, p.raca, p.idade, p.sexo, t.nome AS nome_tutor
            FROM pacientes p
            JOIN tutores t ON p.idTutor = t.id"; // Certifique-se de que 'idTutor' existe em 'pacientes'
    ...
    return $pacientes; // Retorna os pacientes para serem usados onde necessário
}
