...
class Tutor
{
    ...
    public function __construct() {
        try {
            ...
            $this->pdo = new PDO("mysql:host=localhost;dbname=tccdois", "root", "");
    ...
    public function listar() {
        $query = "SELECT id, nome, email, telefone,endereco, cidade, estado, cep FROM tutores"; // Remova 'endereco' se não existir
