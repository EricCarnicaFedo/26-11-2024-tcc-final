...
<body class="bg-gray-100">
    ...
    <div class="bg-white p-6 rounded shadow-md">
        ...
        <div class="flex justify-between items-center mb-4 flex-wrap">
            <div class="flex space-x-4">
                 <button class="bg-blue-500 text-white px-4 py-2 rounded flex items-center" onclick="window.location.href='adicionarpaciente.php';">
    ...
    ?>
    <tr>
        <td style="padding: 10px; text-align: center;"><?php echo isset($registro["idPaciente"]) ? $registro["idPaciente"] : "N/A"; ?></td>
        <td style="padding: 10px; text-align: center;"><?php echo isset($registro["nome"]) ? $registro["nome"] : "N/A"; ?></td>
        <td style="padding: 10px; text-align: center;"><?php echo isset($registro["raca"]) ? $registro["raca"] : "N/A"; ?></td>
        <td style="padding: 10px; text-align: center;"><?php echo isset($registro["nome_tutor"]) ? $registro["nome_tutor"] : "N/A"; ?></td>
        <td style="padding: 10px; text-align: center;"><?php echo isset($registro["idade"]) ? $registro["idade"] : "N/A"; ?></td>
        <td style="padding: 10px; text-align: center;">
            <?php echo isset($registro["sexo"]) ? ($registro["sexo"] == 'Macho' ? 'Macho' : 'Fêmea') : "N/A"; ?>
        </td>
        <td style="padding: 10px; text-align: center;">
...
<td style="padding: 10px; text-align: center;"><?php echo htmlspecialchars($registro["idExame"]); ?></td>
    <td style="padding: 10px; text-align: center;"><?php echo htmlspecialchars($registro["idPaciente"]); ?></td>
...
<main class="p-6">
    <div class="bg-white p-6 rounded shadow-md">
        ...
        <div class="flex justify-between items-center mb-4 flex-wrap">
            <div class="flex space-x-4">
            <button class="bg-blue-500 text-white px-4 py-2 rounded flex items-center" onclick="window.location.href='adicionartratamento.php';">
    ...
    <tr>
        ...
        <td style="padding: 10px; text-align: center;"><?php echo $registro["descricao"]; ?></td>
        <td style="padding: 10px; text-align: center;"><?php echo $registro["data_inicio"]; ?></td>
        <td style="padding: 10px; text-align: center;"><?php echo $registro["data_fim"]; ?></td>
        <td style="padding: 10px; text-align: center;">
